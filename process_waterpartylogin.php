...
if(empty($_POST)) { header("location:waterparty.php");}
		...
		else
		{
			...
			$res = $d->get("select * from registration where user_name = '".$_POST['user_name']."' and password = '".$_POST['password']."'");
				...
				if(mysqli_num_rows($res) > 0)
				{
					...
					header("location:waterparty.php");
				...
				{	
					...
					echo "&nbsp;&nbsp;&nbsp;<p><li align='center'>Username & Password Same  As Registration";
					 echo "<p><form action='waterpartylogin.php' align='center'> <input type='submit' name='btnlogin' value='Login Now'></form>";
				}
			}
