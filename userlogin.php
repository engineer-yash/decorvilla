...
<table width="991" height="321" border="5" align="center" bgcolor="#D1D1D1">
  <tr>	
<form name="registration" action="process_ulogin.php" method="post">
      <div align="center"><br />
  ...
  <td>&nbsp; </td>
      ...
      <tr>
        <td height="68" align="center" colspan="2"><input type="submit" value="Login" class="btn register" id="submit" name="submit" style="background-color:#FFFFFF"> </td>
    </tr>
    </table>
  </div>
</form>
